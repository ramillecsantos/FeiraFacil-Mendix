...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "C:/Users/Ramille/Desktop/ProjetoTrue/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
            sourceMap: !isProduction,
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "C:/Users/Ramille/Desktop/ProjetoTrue/deployment",
        }),
        mendixCopy({
            targets: [
                {
                    dest: "dist",
                    exclude: [".js", ".mjs"],
                    src: "C:/Users/Ramille/Desktop/ProjetoTrue/deployment/web/widgets",
                },
            ],
        }),
    ],
